...
using IdentitySample.BusinessLayer.Services.IdentityModule;
...
namespace IdentitySample.Controllers
{
    ...
    {
        private readonly IdentitySample.BusinessLayer.Services.IdentityModule.UserManager _userManager;
        public AccountController(IdentitySample.BusinessLayer.Services.IdentityModule.UserManager userManager)
        {
        ...
        {
            var user = _userManager.FindById(User.Identity.GetUserId().ToString());
            if (user != null)
            {
